package com.hitmanlabs.eps.handler;

import com.hitmanlabs.eps.ModContants;
import com.hitmanlabs.eps.item.SubItems;
...
public class RegistrationHandler {
    ...
    @Mod.EventBusSubscriber(modid = ModContants.MODID)
    ...
    public static class Models
    {
        ...
        private static void registerRender(Item item)
        {
            ...
            {
                ModelLoader.setCustomModelResourceLocation(item, 0, new ModelResourceLocation(ModContants.MODID + ":" + item.getUnlocalizedName().substring(5), "inventory"));
            }
        }
    }
